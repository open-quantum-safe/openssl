...
static const char* OQS_CURVE_ID_NAME_STR(int id) {
  ...
  case 0x0206: return "bike1l1";
  case 0x0207: return "bike1l3";
  case 0x0208: return "bike1l5";
  case 0x0209: return "bike2l1";
  case 0x020A: return "bike2l3";
  case 0x020B: return "bike2l5";
  case 0x020C: return "bike3l1";
  case 0x020D: return "bike3l3";
  case 0x020E: return "bike3l5";
  ...
  case 0x0306: return "p256-bike1l1 hybrid";
  case 0x0307: return "p256-bike1l3 hybrid";
  case 0x0308: return "p256-bike1l5 hybrid";
  case 0x0309: return "p256-bike2l1 hybrid";
  case 0x030A: return "p256-bike2l3 hybrid";
  case 0x030B: return "p256-bike2l5 hybrid";
  case 0x030C: return "p256-bike3l1 hybrid";
  case 0x030D: return "p256-bike3l3 hybrid";
  case 0x030E: return "p256-bike3l5 hybrid";
