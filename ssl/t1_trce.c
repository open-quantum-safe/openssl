...
///// OQS_TEMPLATE_FRAGMENT_SSL_GROUPS_TBL_START
    ...
    {OQS_KEM_CURVEID(NID_ledacryptkemlt12), "ledacryptkemlt12"},
    {OQS_KEM_CURVEID(NID_ledacryptkemlt32), "ledacryptkemlt32"},
    {OQS_KEM_CURVEID(NID_ledacryptkemlt52), "ledacryptkemlt52"},
...
///// OQS_TEMPLATE_FRAGMENT_SSL_GROUPS_TBL_HYBRID_START
    ...
    {OQS_KEM_CURVEID(NID_p256_bike1l3cpa), "p256 - bike1l3cpa hybrid"},
    {OQS_KEM_CURVEID(NID_p256_bike1l1fo), "p256 - bike1l1fo hybrid"},
    {OQS_KEM_CURVEID(NID_p256_bike1l3fo), "p256 - bike1l3fo hybrid"},
    ...
    {OQS_KEM_CURVEID(NID_p256_newhope1024cca), "p256 - newhope1024cca hybrid"},
    {OQS_KEM_CURVEID(NID_p256_ntru_hps2048509), "p256 - ntru_hps2048509 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_ntru_hps2048677), "p256 - ntru_hps2048677 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_ntru_hps4096821), "p256 - ntru_hps4096821 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_ntru_hrss701), "p256 - ntru_hrss701 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_lightsaber), "p256 - lightsaber hybrid"},
    {OQS_KEM_CURVEID(NID_p256_saber), "p256 - saber hybrid"},
    {OQS_KEM_CURVEID(NID_p256_firesaber), "p256 - firesaber hybrid"},
    {OQS_KEM_CURVEID(NID_p256_sidhp434), "p256 - sidhp434 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_sidhp503), "p256 - sidhp503 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_sidhp610), "p256 - sidhp610 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_sidhp751), "p256 - sidhp751 hybrid"},
    ...
    {OQS_KEM_CURVEID(NID_p256_ledacryptkemlt12), "p256 - ledacryptkemlt12 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_ledacryptkemlt32), "p256 - ledacryptkemlt32 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_ledacryptkemlt52), "p256 - ledacryptkemlt52 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_kyber90s512), "p256 - kyber90s512 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_kyber90s768), "p256 - kyber90s768 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_kyber90s1024), "p256 - kyber90s1024 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_babybear), "p256 - babybear hybrid"},
    {OQS_KEM_CURVEID(NID_p256_mamabear), "p256 - mamabear hybrid"},
    {OQS_KEM_CURVEID(NID_p256_papabear), "p256 - papabear hybrid"},
    {OQS_KEM_CURVEID(NID_p256_babybearephem), "p256 - babybearephem hybrid"},
    {OQS_KEM_CURVEID(NID_p256_mamabearephem), "p256 - mamabearephem hybrid"},
    {OQS_KEM_CURVEID(NID_p256_papabearephem), "p256 - papabearephem hybrid"},
    ...
    {OQS_KEM_CURVEID(NID_p256_classicmceliece460896), "p256 - classicmceliece460896 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_classicmceliece460896f), "p256 - classicmceliece460896f hybrid"},
    {OQS_KEM_CURVEID(NID_p256_classicmceliece6688128), "p256 - classicmceliece6688128 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_classicmceliece6688128f), "p256 - classicmceliece6688128f hybrid"},
    {OQS_KEM_CURVEID(NID_p256_classicmceliece6960119), "p256 - classicmceliece6960119 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_classicmceliece6960119f), "p256 - classicmceliece6960119f hybrid"},
    {OQS_KEM_CURVEID(NID_p256_classicmceliece8192128), "p256 - classicmceliece8192128 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_classicmceliece8192128f), "p256 - classicmceliece8192128f hybrid"},
