...
///// OQS_TEMPLATE_FRAGMENT_SSL_GROUPS_TBL_START
    ...
    {OQS_KEM_CURVEID(NID_OQS_bike1l1), "bike1l1"},
    {OQS_KEM_CURVEID(NID_OQS_bike1l3), "bike1l3"},
    {OQS_KEM_CURVEID(NID_OQS_bike1l5), "bike1l5"},
    {OQS_KEM_CURVEID(NID_OQS_bike2l1), "bike2l1"},
    {OQS_KEM_CURVEID(NID_OQS_bike2l3), "bike2l3"},
    {OQS_KEM_CURVEID(NID_OQS_bike2l5), "bike2l5"},
    {OQS_KEM_CURVEID(NID_OQS_bike3l1), "bike3l1"},
    {OQS_KEM_CURVEID(NID_OQS_bike3l3), "bike3l3"},
    {OQS_KEM_CURVEID(NID_OQS_bike3l5), "bike3l5"},
...
///// OQS_TEMPLATE_FRAGMENT_SSL_GROUPS_TBL_HYBRID_START
    ...
    {OQS_KEM_CURVEID(NID_OQS_p256_bike1l1), "p256 - bike1l1 hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_bike1l3), "p256 - bike1l3 hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_bike1l5), "p256 - bike1l5 hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_bike2l1), "p256 - bike2l1 hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_bike2l3), "p256 - bike2l3 hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_bike2l5), "p256 - bike2l5 hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_bike3l1), "p256 - bike3l1 hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_bike3l3), "p256 - bike3l3 hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_bike3l5), "p256 - bike3l5 hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_kyber512), "p256 - kyber512 hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_kyber768), "p256 - kyber768 hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_kyber1024), "p256 - kyber1024 hybrid"},
