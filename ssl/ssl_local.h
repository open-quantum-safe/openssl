...
/* Falcon-512 auth */
#define SSL_aFALCON512 0x00004000U
/* ECDSA p256 - Falcon-512 auth */
#define SSL_aP256_FALCON512 0x00008000U
/* RSA3072 - Falcon-512 auth */
#define SSL_aRSA3072_FALCON512 0x00010000U
/* MQDSS-31-48 auth */
#define SSL_aMQDSS3148 0x00020000U
/* ECDSA p256 - MQDSS-31-48 auth */
#define SSL_aP256_MQDSS3148 0x00040000U
/* RSA3072 - MQDSS-31-48 auth */
#define SSL_aRSA3072_MQDSS3148 0x00080000U
/* Picnic L1 UR auth */
#define SSL_aPICNICL1UR 0x00100000U
/* ECDSA p256 - Picnic L1 UR auth */
#define SSL_aP256_PICNICL1UR 0x00200000U
/* RSA3072 - Picnic L1 UR auth */
#define SSL_aRSA3072_PICNICL1UR 0x00400000U
/* qTesla-I-p auth */
#define SSL_aQTESLAPI 0x00800000U
/* ECDSA p256 - qTesla-I-p auth */
#define SSL_aP256_QTESLAPI 0x01000000U
/* RSA3072 - qTesla-I-p auth */
#define SSL_aRSA3072_QTESLAPI 0x02000000U
/* qTESLA-p-III auth */
#define SSL_aQTESLAPIII 0x04000000U
/* ECDSA p384 - qTESLA-p-III auth */
#define SSL_aP384_QTESLAPIII 0x08000000U
/* Rainbow-Ia-Classic auth */
#define SSL_aRAINBOWIACLASSIC 0x10000000U
/* ECDSA p256 - Rainbow-Ia-Classic auth */
#define SSL_aP256_RAINBOWIACLASSIC 0x20000000U
/* RSA3072 - Rainbow-Ia-Classic auth */
#define SSL_aRSA3072_RAINBOWIACLASSIC 0x40000000U
/* Rainbow-Vc-Classic auth */
#define SSL_aRAINBOWVCCLASSIC 0x80000000U
/* ECDSA p521 - Rainbow-Vc-Classic auth */
#define SSL_aP521_RAINBOWVCCLASSIC 0x100000000U
/* SPHINCS+-Haraka-128f-robust auth */
#define SSL_aSPHINCSHARAKA128FROBUST 0x200000000U
/* ECDSA p256 - SPHINCS+-Haraka-128f-robust auth */
#define SSL_aP256_SPHINCSHARAKA128FROBUST 0x400000000U
/* RSA3072 - SPHINCS+-Haraka-128f-robust auth */
#define SSL_aRSA3072_SPHINCSHARAKA128FROBUST 0x800000000U
...
#define SSL_PKEY_FALCON512 15
#define SSL_PKEY_P256_FALCON512 16
#define SSL_PKEY_RSA3072_FALCON512 17
#define SSL_PKEY_MQDSS3148 18
#define SSL_PKEY_P256_MQDSS3148 19
#define SSL_PKEY_RSA3072_MQDSS3148 20
#define SSL_PKEY_PICNICL1UR 21
#define SSL_PKEY_P256_PICNICL1UR 22
#define SSL_PKEY_RSA3072_PICNICL1UR 23
...
#define SSL_PKEY_RAINBOWIACLASSIC 29
#define SSL_PKEY_P256_RAINBOWIACLASSIC 30
#define SSL_PKEY_RSA3072_RAINBOWIACLASSIC 31
#define SSL_PKEY_RAINBOWVCCLASSIC 32
#define SSL_PKEY_P521_RAINBOWVCCLASSIC 33
#define SSL_PKEY_SPHINCSHARAKA128FROBUST 34
#define SSL_PKEY_P256_SPHINCSHARAKA128FROBUST 35
#define SSL_PKEY_RSA3072_SPHINCSHARAKA128FROBUST 36

#define SSL_PKEY_NUM 37
...
#define TLSEXT_SIGALG_picnicl1ur 0xfe18
#define TLSEXT_SIGALG_p256_picnicl1ur 0xfe19
#define TLSEXT_SIGALG_rsa3072_picnicl1ur 0xfe1a
