...
///// OQS_TEMPLATE_FRAGMENT_LIST_SIG_SWITCH_CASES_START
    ...
    case EVP_PKEY_P256_RAINBOWIACYCLIC:
    case EVP_PKEY_RSA3072_RAINBOWIACYCLIC:
    case EVP_PKEY_RAINBOWIACYCLICCOMPRESSED:
    case EVP_PKEY_P256_RAINBOWIACYCLICCOMPRESSED:
    case EVP_PKEY_RSA3072_RAINBOWIACYCLICCOMPRESSED:
    case EVP_PKEY_RAINBOWIIICCLASSIC:
    case EVP_PKEY_P384_RAINBOWIIICCLASSIC:
    case EVP_PKEY_RAINBOWIIICCYCLIC:
    case EVP_PKEY_P384_RAINBOWIIICCYCLIC:
    case EVP_PKEY_RAINBOWIIICCYCLICCOMPRESSED:
    case EVP_PKEY_P384_RAINBOWIIICCYCLICCOMPRESSED:
