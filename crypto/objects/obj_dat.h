...
/* Serialized OID's */
static const unsigned char so[8056] = {
    ...
    0x2B,0xCE,0x0F,0x05,0x01,0x01,0x01,            /* [ 7966] OBJ_rainbowIclassic */
    0x2B,0xCE,0x0F,0x05,0x01,0x02,0x01,            /* [ 7973] OBJ_p256_rainbowIclassic */
    0x2B,0xCE,0x0F,0x05,0x01,0x03,0x01,            /* [ 7980] OBJ_rsa3072_rainbowIclassic */
    0x2B,0xCE,0x0F,0x05,0x03,0x01,0x01,            /* [ 7987] OBJ_rainbowVclassic */
    0x2B,0xCE,0x0F,0x05,0x03,0x02,0x01,            /* [ 7994] OBJ_p521_rainbowVclassic */
    0x2B,0xCE,0x0F,0x06,0x01,0x01,                 /* [ 8001] OBJ_sphincsharaka128frobust */
    0x2B,0xCE,0x0F,0x06,0x01,0x02,                 /* [ 8007] OBJ_p256_sphincsharaka128frobust */
    0x2B,0xCE,0x0F,0x06,0x01,0x03,                 /* [ 8013] OBJ_rsa3072_sphincsharaka128frobust */
    0x2B,0xCE,0x0F,0x06,0x04,0x01,                 /* [ 8019] OBJ_sphincssha256128frobust */
    ...
    0x2B,0xCE,0x0F,0x06,0x07,0x01,                 /* [ 8037] OBJ_sphincsshake256128frobust */
    0x2B,0xCE,0x0F,0x06,0x07,0x02,                 /* [ 8043] OBJ_p256_sphincsshake256128frobust */
    0x2B,0xCE,0x0F,0x06,0x07,0x03,                 /* [ 8049] OBJ_rsa3072_sphincsshake256128frobust */
};
...
static const ASN1_OBJECT nid_objs[NUM_NID] = {
    ...
    {"rainbowIclassic", "rainbowIclassic", NID_rainbowIclassic, 7, &so[7966]},
    {"p256_rainbowIclassic", "p256_rainbowIclassic", NID_p256_rainbowIclassic, 7, &so[7973]},
    {"rsa3072_rainbowIclassic", "rsa3072_rainbowIclassic", NID_rsa3072_rainbowIclassic, 7, &so[7980]},
    {"rainbowVclassic", "rainbowVclassic", NID_rainbowVclassic, 7, &so[7987]},
    {"p521_rainbowVclassic", "p521_rainbowVclassic", NID_p521_rainbowVclassic, 7, &so[7994]},
    {"sphincsharaka128frobust", "sphincsharaka128frobust", NID_sphincsharaka128frobust, 6, &so[8001]},
    {"p256_sphincsharaka128frobust", "p256_sphincsharaka128frobust", NID_p256_sphincsharaka128frobust, 6, &so[8007]},
    {"rsa3072_sphincsharaka128frobust", "rsa3072_sphincsharaka128frobust", NID_rsa3072_sphincsharaka128frobust, 6, &so[8013]},
    {"sphincssha256128frobust", "sphincssha256128frobust", NID_sphincssha256128frobust, 6, &so[8019]},
    {"p256_sphincssha256128frobust", "p256_sphincssha256128frobust", NID_p256_sphincssha256128frobust, 6, &so[8025]},
    {"rsa3072_sphincssha256128frobust", "rsa3072_sphincssha256128frobust", NID_rsa3072_sphincssha256128frobust, 6, &so[8031]},
    {"sphincsshake256128frobust", "sphincsshake256128frobust", NID_sphincsshake256128frobust, 6, &so[8037]},
    {"p256_sphincsshake256128frobust", "p256_sphincsshake256128frobust", NID_p256_sphincsshake256128frobust, 6, &so[8043]},
    {"rsa3072_sphincsshake256128frobust", "rsa3072_sphincsshake256128frobust", NID_rsa3072_sphincsshake256128frobust, 6, &so[8049]},
};
...
static const unsigned int sn_objs[NUM_SN] = {
    ...
    1141,    /* "oscca" */
     ...
     876,    /* "owner" */
    1263,    /* "p256_bikel1" */
    1280,    /* "p256_dilithium2" */
    1287,    /* "p256_dilithium2_aes" */
    1294,    /* "p256_falcon512" */
    1238,    /* "p256_frodo640aes" */
    1239,    /* "p256_frodo640shake" */
    1268,    /* "p256_hqc128" */
    1244,    /* "p256_kyber512" */
    1265,    /* "p256_kyber90s512" */
    1252,    /* "p256_lightsaber" */
    1247,    /* "p256_ntru_hps2048509" */
    1271,    /* "p256_ntrulpr653" */
    1272,    /* "p256_ntrulpr761" */
    1302,    /* "p256_picnic3l1" */
    1299,    /* "p256_picnicl1full" */
    1305,    /* "p256_rainbowIclassic" */
    1255,    /* "p256_sidhp434" */
    1256,    /* "p256_sidhp503" */
    1259,    /* "p256_sikep434" */
    1260,    /* "p256_sikep503" */
    1275,    /* "p256_sntrup653" */
    1276,    /* "p256_sntrup761" */
    1310,    /* "p256_sphincsharaka128frobust" */
    1313,    /* "p256_sphincssha256128frobust" */
    1316,    /* "p256_sphincsshake256128frobust" */
    1264,    /* "p384_bikel3" */
    1283,    /* "p384_dilithium3" */
    1290,    /* "p384_dilithium3_aes" */
    1240,    /* "p384_frodo976aes" */
    1241,    /* "p384_frodo976shake" */
    1269,    /* "p384_hqc192" */
    1245,    /* "p384_kyber768" */
    1266,    /* "p384_kyber90s768" */
    1248,    /* "p384_ntru_hps2048677" */
    1251,    /* "p384_ntru_hrss701" */
    1273,    /* "p384_ntrulpr857" */
    1253,    /* "p384_saber" */
    1257,    /* "p384_sidhp610" */
    1261,    /* "p384_sikep610" */
    1277,    /* "p384_sntrup857" */
    1285,    /* "p521_dilithium5" */
    1292,    /* "p521_dilithium5_aes" */
    1297,    /* "p521_falcon1024" */
    1254,    /* "p521_firesaber" */
    1242,    /* "p521_frodo1344aes" */
    1243,    /* "p521_frodo1344shake" */
    1270,    /* "p521_hqc256" */
    1246,    /* "p521_kyber1024" */
    1267,    /* "p521_kyber90s1024" */
    1250,    /* "p521_ntru_hps40961229" */
    1249,    /* "p521_ntru_hps4096821" */
    1274,    /* "p521_ntrulpr1277" */
    1308,    /* "p521_rainbowVclassic" */
    1258,    /* "p521_sidhp751" */
    1262,    /* "p521_sikep751" */
    1278,    /* "p521_sntrup1277" */
    ...
    1033,    /* "pkInitKDC" */
     ...
     450,    /* "rFC822localPart" */
    1304,    /* "rainbowIclassic" */
    1307,    /* "rainbowVclassic" */
     870,    /* "registeredAddress" */
     400,    /* "role" */
     877,    /* "roleOccupant" */
     448,    /* "room" */
     463,    /* "roomNumber" */
    1281,    /* "rsa3072_dilithium2" */
    1288,    /* "rsa3072_dilithium2_aes" */
    1295,    /* "rsa3072_falcon512" */
    1303,    /* "rsa3072_picnic3l1" */
    1300,    /* "rsa3072_picnicl1full" */
    1306,    /* "rsa3072_rainbowIclassic" */
    1311,    /* "rsa3072_sphincsharaka128frobust" */
    1314,    /* "rsa3072_sphincssha256128frobust" */
    1317,    /* "rsa3072_sphincsshake256128frobust" */
       6,    /* "rsaEncryption" */
    ...
    1234,    /* "sntrup761" */
    1235,    /* "sntrup857" */
    1309,    /* "sphincsharaka128frobust" */
    1312,    /* "sphincssha256128frobust" */
    1315,    /* "sphincsshake256128frobust" */
     660,    /* "street" */
      85,    /* "subjectAltName" */
...
static const unsigned int obj_objs[NUM_OBJ] = {
    ...
    1293,    /* OBJ_falcon512                    1 3 9999 3 1 */
    1294,    /* OBJ_p256_falcon512               1 3 9999 3 2 */
    1295,    /* OBJ_rsa3072_falcon512            1 3 9999 3 3 */
    1296,    /* OBJ_falcon1024                   1 3 9999 3 4 */
    1297,    /* OBJ_p521_falcon1024              1 3 9999 3 5 */
    ...
    1280,    /* OBJ_p256_dilithium2              1 3 9999 2 7 1 */
    1281,    /* OBJ_rsa3072_dilithium2           1 3 9999 2 7 2 */
    1283,    /* OBJ_p384_dilithium3              1 3 9999 2 7 3 */
    1285,    /* OBJ_p521_dilithium5              1 3 9999 2 7 4 */
    1287,    /* OBJ_p256_dilithium2_aes          1 3 9999 2 11 1 */
    1288,    /* OBJ_rsa3072_dilithium2_aes       1 3 9999 2 11 2 */
    1290,    /* OBJ_p384_dilithium3_aes          1 3 9999 2 11 3 */
    1292,    /* OBJ_p521_dilithium5_aes          1 3 9999 2 11 4 */
    1309,    /* OBJ_sphincsharaka128frobust      1 3 9999 6 1 1 */
    1310,    /* OBJ_p256_sphincsharaka128frobust 1 3 9999 6 1 2 */
    1311,    /* OBJ_rsa3072_sphincsharaka128frobust 1 3 9999 6 1 3 */
    1312,    /* OBJ_sphincssha256128frobust      1 3 9999 6 4 1 */
    1313,    /* OBJ_p256_sphincssha256128frobust 1 3 9999 6 4 2 */
    1314,    /* OBJ_rsa3072_sphincssha256128frobust 1 3 9999 6 4 3 */
    1315,    /* OBJ_sphincsshake256128frobust    1 3 9999 6 7 1 */
    1316,    /* OBJ_p256_sphincsshake256128frobust 1 3 9999 6 7 2 */
    1317,    /* OBJ_rsa3072_sphincsshake256128frobust 1 3 9999 6 7 3 */
    ...
    1304,    /* OBJ_rainbowIclassic              1 3 9999 5 1 1 1 */
    1305,    /* OBJ_p256_rainbowIclassic         1 3 9999 5 1 2 1 */
    1306,    /* OBJ_rsa3072_rainbowIclassic      1 3 9999 5 1 3 1 */
    1307,    /* OBJ_rainbowVclassic              1 3 9999 5 3 1 1 */
    1308,    /* OBJ_p521_rainbowVclassic         1 3 9999 5 3 2 1 */
    ...
    1279,    /* OBJ_dilithium2                   1 3 6 1 4 1 2 267 7 4 4 */
    1282,    /* OBJ_dilithium3                   1 3 6 1 4 1 2 267 7 6 5 */
    1284,    /* OBJ_dilithium5                   1 3 6 1 4 1 2 267 7 8 7 */
    1286,    /* OBJ_dilithium2_aes               1 3 6 1 4 1 2 267 11 4 4 */
    1289,    /* OBJ_dilithium3_aes               1 3 6 1 4 1 2 267 11 6 5 */
    1291,    /* OBJ_dilithium5_aes               1 3 6 1 4 1 2 267 11 8 7 */
      34,    /* OBJ_idea_cbc                     1 3 6 1 4 1 188 7 1 1 2 */
     955,    /* OBJ_jurisdictionLocalityName     1 3 6 1 4 1 311 60 2 1 1 */
     956,    /* OBJ_jurisdictionStateOrProvinceName 1 3 6 1 4 1 311 60 2 1 2 */
     957,    /* OBJ_jurisdictionCountryName      1 3 6 1 4 1 311 60 2 1 3 */
    1298,    /* OBJ_picnicl1full                 1 3 6 1 4 1 311 89 2 1 7 */
    1299,    /* OBJ_p256_picnicl1full            1 3 6 1 4 1 311 89 2 1 8 */
    1300,    /* OBJ_rsa3072_picnicl1full         1 3 6 1 4 1 311 89 2 1 9 */
    1301,    /* OBJ_picnic3l1                    1 3 6 1 4 1 311 89 2 1 21 */
    1302,    /* OBJ_p256_picnic3l1               1 3 6 1 4 1 311 89 2 1 22 */
    1303,    /* OBJ_rsa3072_picnic3l1            1 3 6 1 4 1 311 89 2 1 23 */
