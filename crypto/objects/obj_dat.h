...
/* Serialized OID's */
static const unsigned char so[8006] = {
    ...
    0x2B,0xCE,0x0F,0x04,0x04,                      /* [ 7874] OBJ_mqdss3164 */
    0x2B,0xCE,0x0F,0x04,0x05,                      /* [ 7879] OBJ_p384_mqdss3164 */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x01,0x01,  /* [ 7884] OBJ_picnicl1fs */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x01,0x02,  /* [ 7895] OBJ_p256_picnicl1fs */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x01,0x03,  /* [ 7906] OBJ_rsa3072_picnicl1fs */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x01,0x0B,  /* [ 7917] OBJ_picnic2l1fs */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x01,0x0C,  /* [ 7928] OBJ_p256_picnic2l1fs */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x01,0x0D,  /* [ 7939] OBJ_rsa3072_picnic2l1fs */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x02,0x0A,  /* [ 7950] OBJ_qteslapi */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x02,0x0B,  /* [ 7961] OBJ_p256_qteslapi */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x02,0x0C,  /* [ 7972] OBJ_rsa3072_qteslapi */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x02,0x14,  /* [ 7983] OBJ_qteslapiii */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x02,0x15,  /* [ 7994] OBJ_p384_qteslapiii */
};
...
static const ASN1_OBJECT nid_objs[NUM_NID] = {
    ...
    {"mqdss3164", "mqdss3164", NID_mqdss3164, 5, &so[7874]},
    {"p384_mqdss3164", "p384_mqdss3164", NID_p384_mqdss3164, 5, &so[7879]},
    {"picnicl1fs", "picnicl1fs", NID_picnicl1fs, 11, &so[7884]},
    {"p256_picnicl1fs", "p256_picnicl1fs", NID_p256_picnicl1fs, 11, &so[7895]},
    {"rsa3072_picnicl1fs", "rsa3072_picnicl1fs", NID_rsa3072_picnicl1fs, 11, &so[7906]},
    {"picnic2l1fs", "picnic2l1fs", NID_picnic2l1fs, 11, &so[7917]},
    {"p256_picnic2l1fs", "p256_picnic2l1fs", NID_p256_picnic2l1fs, 11, &so[7928]},
    {"rsa3072_picnic2l1fs", "rsa3072_picnic2l1fs", NID_rsa3072_picnic2l1fs, 11, &so[7939]},
    {"qteslapi", "qteslapi", NID_qteslapi, 11, &so[7950]},
    {"p256_qteslapi", "p256_qteslapi", NID_p256_qteslapi, 11, &so[7961]},
    {"rsa3072_qteslapi", "rsa3072_qteslapi", NID_rsa3072_qteslapi, 11, &so[7972]},
    {"qteslapiii", "qteslapiii", NID_qteslapiii, 11, &so[7983]},
    {"p384_qteslapiii", "p384_qteslapiii", NID_p384_qteslapiii, 11, &so[7994]},
};
...
static const unsigned int obj_objs[NUM_OBJ] = {
    ...
    1282,    /* OBJ_p256_dilithium3              1 3 9999 2 4 */
    1283,    /* OBJ_rsa3072_dilithium3           1 3 9999 2 5 */
    1285,    /* OBJ_p384_dilithium4              1 3 9999 2 6 */
    1286,    /* OBJ_falcon512                    1 3 9999 3 1 */
    1287,    /* OBJ_p256_falcon512               1 3 9999 3 2 */
    ...
    1294,    /* OBJ_mqdss3164                    1 3 9999 4 4 */
    1295,    /* OBJ_p384_mqdss3164               1 3 9999 4 5 */
    ...
    1284,    /* OBJ_dilithium4                   1 3 6 1 4 1 2 267 6 6 5 */
