...
static const unsigned char so[7928] = {
    ...
    0x2B,0xCE,0x0F,0x01,0x01,                      /* [ 7761] OBJ_oqsdefault */
    0x2B,0xCE,0x0F,0x01,0x02,                      /* [ 7766] OBJ_p256_oqsdefault */
    0x2B,0xCE,0x0F,0x01,0x03,                      /* [ 7771] OBJ_rsa3072_oqsdefault */
...
static const ASN1_OBJECT nid_objs[NUM_NID] = {
    ...
    {"oqsdefault", "oqsdefault", NID_oqsdefault, 5, &so[7761]},
    {"p256_oqsdefault", "p256_oqsdefault", NID_p256_oqsdefault, 5, &so[7766]},
    {"rsa3072_oqsdefault", "rsa3072_oqsdefault", NID_rsa3072_oqsdefault, 5, &so[7771]},
...
static const unsigned int sn_objs[NUM_SN] = {
    ...
    1291,    /* "newhope512cca" */
     ...
     139,    /* "nsSGC" */
      77,    /* "nsSslServerName" */
    1293,    /* "ntru_hps2048509" */
    1294,    /* "ntru_hps2048677" */
    1295,    /* "ntru_hps4096821" */
    1296,    /* "ntru_hrss701" */
     681,    /* "onBasis" */
    1195,    /* "oqsdefault" */
    ...
    1141,    /* "oscca" */
     475,    /* "otherMailbox" */
     876,    /* "owner" */
    1339,    /* "p256_OQS_KEM_DEFAULT" */
    1315,    /* "p256_bike1l1cpa" */
    1317,    /* "p256_bike1l1fo" */
    1316,    /* "p256_bike1l3cpa" */
    1318,    /* "p256_bike1l3fo" */
    1199,    /* "p256_dilithium2" */
    1330,    /* "p256_firesaber" */
    1313,    /* "p256_frodo1344aes" */
    1314,    /* "p256_frodo1344shake" */
    1309,    /* "p256_frodo640aes" */
    1310,    /* "p256_frodo640shake" */
    1311,    /* "p256_frodo976aes" */
    1312,    /* "p256_frodo976shake" */
    1321,    /* "p256_kyber1024" */
    1319,    /* "p256_kyber512" */
    1320,    /* "p256_kyber768" */
    1328,    /* "p256_lightsaber" */
    1323,    /* "p256_newhope1024cca" */
    1322,    /* "p256_newhope512cca" */
    1324,    /* "p256_ntru_hps2048509" */
    1325,    /* "p256_ntru_hps2048677" */
    1326,    /* "p256_ntru_hps4096821" */
    1327,    /* "p256_ntru_hrss701" */
    1196,    /* "p256_oqsdefault" */
    1208,    /* "p256_picnic2l1fs" */
    1205,    /* "p256_picnicl1fs" */
    1211,    /* "p256_qteslapi" */
    1329,    /* "p256_saber" */
    1331,    /* "p256_sidhp434" */
    1332,    /* "p256_sidhp503" */
    ...
    1197,    /* "rsa3072_oqsdefault" */
    1209,    /* "rsa3072_picnic2l1fs" */
    1206,    /* "rsa3072_picnicl1fs" */
...
static const unsigned int obj_objs[NUM_OBJ] = {
    ...
    1195,    /* OBJ_oqsdefault                   1 3 9999 1 1 */
    1196,    /* OBJ_p256_oqsdefault              1 3 9999 1 2 */
    1197,    /* OBJ_rsa3072_oqsdefault           1 3 9999 1 3 */
    1198,    /* OBJ_dilithium2                   1 3 9999 2 1 */
    1199,    /* OBJ_p256_dilithium2              1 3 9999 2 2 */
    1200,    /* OBJ_rsa3072_dilithium2           1 3 9999 2 3 */
    1201,    /* OBJ_dilithium3                   1 3 9999 2 4 */
    1202,    /* OBJ_dilithium4                   1 3 9999 2 5 */
    1203,    /* OBJ_p384_dilithium4              1 3 9999 2 6 */
    ...
    1204,    /* OBJ_picnicl1fs                   1 3 6 1 4 1 311 89 2 1 1 */
    1205,    /* OBJ_p256_picnicl1fs              1 3 6 1 4 1 311 89 2 1 2 */
    1206,    /* OBJ_rsa3072_picnicl1fs           1 3 6 1 4 1 311 89 2 1 3 */
    1207,    /* OBJ_picnic2l1fs                  1 3 6 1 4 1 311 89 2 1 11 */
    1208,    /* OBJ_p256_picnic2l1fs             1 3 6 1 4 1 311 89 2 1 12 */
    1209,    /* OBJ_rsa3072_picnic2l1fs          1 3 6 1 4 1 311 89 2 1 13 */
