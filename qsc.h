...
#define QSC_SIG_CPS \
    ...
    { 0xfe67, "sphincssha2128ssimple" }, \
    { 0xfe68, "p256_sphincssha2128ssimple" }, \
    { 0xfe69, "rsa3072_sphincssha2128ssimple" }, \
    { 0xfe7d, "sphincsshake128fsimple" }, \
    { 0xfe7e, "p256_sphincsshake128fsimple" }, \
    { 0xfe7f, "rsa3072_sphincsshake128fsimple" }, \
...
#define QSC_SIGS \
	...
	oid_add_from_string("sphincssha2128ssimple", "1.3.9999.6.4.10"); \
	oid_add_from_string("p256_sphincssha2128ssimple", "1.3.9999.6.4.11"); \
	oid_add_from_string("rsa3072_sphincssha2128ssimple", "1.3.9999.6.4.12"); \
	oid_add_from_string("sphincsshake128fsimple", "1.3.9999.6.7.4"); \
	oid_add_from_string("p256_sphincsshake128fsimple", "1.3.9999.6.7.5"); \
	oid_add_from_string("rsa3072_sphincsshake128fsimple", "1.3.9999.6.7.6"); \
